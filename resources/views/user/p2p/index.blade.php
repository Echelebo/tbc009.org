                ...
                <div class="card-body" id="pageContent">
                    ...
                    <div class="w-full lg:w-2/3-x">
                                        ...
                                        <div class="flex justify-end items-center  mb-2 mt-5">
                                            <div class="relative">
                                                ...
                                                <label for="search-transfer-input"
                                                    class="placeholder-label text-gray-300  px-2">Txn
                                                    Ref
                                                </label>
                                                ...
                                                <div class="flex justify-end items-center space-x-1">
                                                    @if ($transfer->sender_id == user()->id)
                                                        <div class="">
                                                            ...
                                                            <p class="flex justify-end">to {{ $transfer->receiver_name }}
                                                            </p>
                                                        </div>
                                                    @else
                                                        <div class="">
                                                            <p class="text-green-500 flex justify-end uppercase">Received
                                                            </p>
                                                            <p class="flex justify-end">from {{ $transfer->receiver_name }}
                                                            </p>
                                                        </div>
                                                    @endif
                                                </div>
                        ...
                        <div class="w-full p-5 mb-5  rounded-lg rescron-card transition-all hidden" id="new-transfer">
                            <h3 class="capitalize  font-extrabold "><span class="border-b-2 text-16"
                                    style="color:#333333;">New transfer</span>
                            </h3>
                                ...
                                <div class="mt-5 hidden" id="display-new-transfer-information">
                                    <div class=" p-2 rounded w-full">
                                        ...
                                        <div class="grid grid-cols-2 gap-2 text-mono text-sm break-all">
                                            ...
                                            <h2 class="font-bold" style="font-size: 14px;"><span
                                                    id="display_transfer_network" class="clipboard cursor-pointer"
                                                    data-copy=""></span>
                                            </h2>
                                            ...
                                            <h2 class="font-bold" style="font-size: 14px;"><span
                                                    id="display_transfer_ref" class="clipboard cursor-pointer"
                                                    data-copy=""></span>
                                            </h2>
                                    ...
                                    <div class="flex  space-x-2">
                                        ...
                                        <div class=" p-2 rounded w-full">
                                            <div class="grid grid-cols-2 gap-2 text-mono text-sm">
                                                <h2 class="text-16" style="color:#333333;">
                                                    Minimum transfer </h2>
                                                <h2 class="font-bold text-16" style="color:#333333;">
                                                    :{{ formatAmount(site('min_transfer')) }}
                                                </h2>
                                                <h2 class="text-16" style="color:#333333;">Maximum transfer </h2>
                                                <h2 class="font-bold text-16" style="color:#333333;">
                                                    :{{ formatAmount(site('max_transfer')) }}
                                                </h2>
                                                <h2 class="text-16" style="color:#333333;">Fee </h2>
                                                <h2 class="font-bold text-16" style="color:#333333;">
                                                    :{{ site('transfer_fee') }}%</h2>
