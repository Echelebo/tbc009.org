                ...
                <div class="card my-4" style="background-color:#fff; color:#111010">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-3 mt-8" style="padding-left: 20px">
                                <h2>
                                        ...
                                        <div class="col-6 text-center">
                                            ...
                                            @if ($recoveries !== 'none')
                                                @if ($recoveries->status == 0)
                                                    <button type="button"
                                                        class="btn btn-lg btn-primary bg-green-500 disabled"
                                                        data-toggle="modal-x" data-target="#myModal-x"
